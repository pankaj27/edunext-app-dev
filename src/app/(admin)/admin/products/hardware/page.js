...
export default function Page() {
  ...
  async function load() {
    ...
    setError("");
    try {
      const res = await fetch("/api/admin/products/hardware", { cache: "no-store" });
      if (!res.ok) {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      const url = isEditing ? `/api/admin/products/hardware/${editingId}` : "/api/admin/products/hardware";
  ...
  async function onDelete(item) {
    ...
    try {
      const res = await fetch(`/api/admin/products/hardware/${item.id}`, { method: "DELETE" });
      if (!res.ok) {
        const data = await res.json().catch(() => null);
    ...
    <div className="hardware">
      <div className="card border-0 shadow-sm">
        <div className="card-body p-4 p-lg-5">
          <div className="d-flex align-items-start justify-content-between gap-3 flex-wrap">
            <div>
              <div className="h5 mb-1">Hardware Product</div>
              <div className="text-muted small">Add and manage hardware products.</div>
            </div>
            {isEditing ? (
          ...
          <form className="mt-4" onSubmit={onSubmit}>
            <div className="row g-3">
              ...
              <div className="col-12 col-lg-6">
                ...
                <input className="form-control" type="file" accept="image/*" multiple onChange={onPickImages} disabled={isSaving} />
      ...
      <div className="card border-0 shadow-sm mt-3">
        <div className="card-body p-0">
          <div className="p-4 p-lg-5 pb-3 d-flex align-items-center justify-content-between gap-2 flex-wrap">
            <div>
              <div className="h6 mb-1">Hardware Products</div>
              <div className="text-muted small">All hardware products list.</div>
            </div>
          </div>
